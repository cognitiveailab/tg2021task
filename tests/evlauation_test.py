...
from evaluate import ExplanationEvaluate
...
class EvaluationTest(unittest.TestCase):
    def test_mean_ndcg(self):
        ...
        ndcg_score = ExplanationEvaluate.mean_average_ndcg(gold, predicted, 0)
    ...
    def test_repeated_entries(self):
        ...
        ndcg_score_1 = ExplanationEvaluate.mean_average_ndcg(gold, predicted, 0)
        predicted = {"q_id_2": ["id3", "id2", "id2"]}
        ndcg_score_2 = ExplanationEvaluate.mean_average_ndcg(gold, predicted, 0)
